...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TeamMember>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProjectId, "FK9op27dqqmmtqqkxnwbug4tex7");

            entity.HasIndex(e => e.EmpId, "FKe8s3pujlrq1uj4vyunwjnfsfl");
            ...
            entity.HasOne(d => d.Emp).WithMany(p => p.TeamMembers)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FKe8s3pujlrq1uj4vyunwjnfsfl");

            entity.HasOne(d => d.Project).WithMany(p => p.TeamMembers)
                .HasForeignKey(d => d.ProjectId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK9op27dqqmmtqqkxnwbug4tex7");
        });
